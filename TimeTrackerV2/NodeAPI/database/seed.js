...
db.serialize(() => {
    db.run(`CREATE TABLE IF NOT EXISTS Users(userID INTEGER PRIMARY KEY, 
        ...
        salt TEXT NOT NULL);`)
    .run(`CREATE TABLE IF NOT EXISTS Profiles(userID INTEGER NOT NULL,
        pronouns TEXT,
        bio TEXT,
        contact TEXT,
        FOREIGN KEY (userID) REFERENCES Users (userID) ON DELETE CASCADE);`)
    .run(`CREATE TRIGGER IF NOT EXISTS profileTrigger
...
db.run(`CREATE TABLE IF NOT EXISTS Pend_Course_Users (userID INTEGER NOT NULL,
                            courseID INTEGER NOT NULL,
                            FOREIGN KEY (userID) REFERENCES Users (userID) ON DELETE CASCADE,
                            FOREIGN KEY (courseID) REFERENCES Courses (courseID) ON DELETE CASCADE);`);
