...
db.serialize(() => {
    ...
    db.run(`CREATE TABLE IF NOT EXISTS Users(
        ...
        .run(`INSERT OR REPLACE INTO Users(userID, username, password, firstName, lastName, type, isActive, salt)
        ...
        WHERE NOT EXISTS (
            ...
            if (err) {
                ...
                console.log(err);
                localStorage.setItem('defaultAdminCreatedOrEnabledAndNotViewed', false);
            }
            // If the a row was inserted, then "this.lastID" returns the ID of the row it was inserted into.  And because any thing above 0 is considered true, set the variable "global.defaultAdminCreated" to true because the default admin account was inserted.
                ...
                console.log(`Default admin account created/enabled with an ID of: ${this.lastID}`);
                localStorage.setItem('defaultAdminCreatedOrEnabledAndNotViewed', true);
            }
            else {
                localStorage.setItem('defaultAdminCreatedOrEnabledAndNotViewed', false);
            }
