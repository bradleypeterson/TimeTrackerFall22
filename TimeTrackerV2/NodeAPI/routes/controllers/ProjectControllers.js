...
exports.GetActiveProjectsForUser = (req, res) => {
  console.log(
    "ProjectControllers.js file/GetActiveProjectsForUser route called"
  );
...
exports.GetAllProjectsForCourse = (req, res) => {
  console.log(
    "ProjectControllers.js file/GetAllProjectsForCourse route called"
  );
...
// exports.GetUserProjectsForCourse

exports.GetUserProjectsForCourse = (req, res) => {
  console.log(
    "ProjectControllers.js file/GetUserProjectsForCourse route called"
  );
...
exports.GetNonUserProjectsForCourse = (req, res) => {
  console.log(
    "ProjectControllers.js file/GetNonUserProjectsForCourse route called"
  );
...
exports.JoinGroup = async (req, res) => {
  ...
  db.run(
    `INSERT INTO Project_Users(userID, projectID)
        VALUES(?, ?)`,
    data,
    function (err) {
      if (err) {
...
exports.GetAllStudentsInProject = (req, res) => {
  console.log(
    "ProjectControllers.js file/GetAllStudentsInProject route called"
  );
...
exports.GetAllStudentsNotInProject = (req, res) => {
  console.log(
    "ProjectControllers.js file/GetAllStudentsNotInProject route called"
  );
...
exports.CreateProject = async (req, res, next) => {
  ...
  db.run(
    `INSERT INTO Projects(projectName, isActive, courseID, description)
        VALUES(?, ?, ?, ?)`,
    data,
    function (err, rows) {
      if (err) {
